...
export const CACHE_VERSIONS = {
  IMAGE: {
    current: '1.1.0',
    migrations: {
      '1.0.0': '1.1.0', // Added metadata support
      '1.1.0': '1.2.0'  // Future upgrade path
    }
  },
  URL: {
    current: '1.0.1',
    migrations: {
      '1.0.0': '1.0.1', // Added validation
      '1.0.1': '1.1.0'  // Future upgrade path
    }
  },
  QUERY: {
    current: '1.0.0',
    migrations: {
      '1.0.0': '1.1.0'  // Future upgrade path
    }
  },
  STORAGE: {
    current: '1.0.0',
...
export const migrateCache = async (
  ...
  switch (fromVersion) {
    case '1.0.0':
      if (toVersion === '1.1.0') {
        // Add metadata to existing cache entries
        return {
          ...data,
          metadata: {
            version: toVersion,
