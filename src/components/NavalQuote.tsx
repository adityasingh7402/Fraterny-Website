      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-2">
            {/* CUSTOMIZATION: Featured Quote 
            // Change the quote text and attribution as needed
            */}
          ...
          {/* CUSTOMIZATION: Supporting Quote/Text */}
          ...
          <div className="grid md:grid-cols-2 gap-8 bg-gradient-to-br from-navy/5 to-navy/10 rounded-2xl p-8">
            <div className="space-y-4">
              {/* CUSTOMIZATION: Statistics - First Stat */}
            ...
            <div className="space-y-4">
              {/* CUSTOMIZATION: Statistics - Second Stat */}
