  ...
  return (
    <section className='bg-sky-800 flex flex-col justify-between h-dvh overflow-hidden'>
        ...
        <div className=' pl-5 xs:pr-0 py-2'>
          ...
          <div className="w-full justify-start text-white text-xl font-normal font-['Gilroy-Regular'] mb-3">Self Introspection Test - 15 minutes. Do you know yourself?.</div>
