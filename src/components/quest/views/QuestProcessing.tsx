...
//   // try {
//   //   console.log(`🔍 MOCK: Polling attempt ${pollCount + 1} for results...`);
    
//   //   // MOCK: Simulate processing time - ready after 3 attempts (15 seconds)
//   //   await new Promise(resolve => setTimeout(resolve, 500)); // Small delay
    
//   //   const mockReady = pollCount >= 2; // Ready after 3rd attempt
//   //   const mockResponse = { 
//   //     data: { 
//   //       status: mockReady ? 'ready' : 'processing', 
//   //       ready: mockReady 
//   //     } 
//   //   };
...
//   //   if (mockResponse.data.status === 'ready' || mockResponse.data.ready === true) {
//   //     console.log('✅ MOCK: Results are ready!');
//   //     setResultStatus('ready');
//   //     setIsPolling(false);
...
//   //     navigate(resultUrl);
//   //   } else {
//   //     console.log('⏳ MOCK: Results still processing...');
//   //     setPollCount(prev => prev + 1);
//   //   }
//   // } catch (error: any) {
//   //   console.error('❌ MOCK: Simulated API error:', error.message);
    
//   //   if (pollCount >= 20) {
//   //     console.log('⚠️ MOCK: Too many attempts, enabling manual continue');
//   //     setResultStatus('error');
//   //     setIsPolling(false);
//   //     setIsTimedOut(true);
//   //   }
...
//   return (
//     <div className = 'bg-[#004A7F] h-screen overflow-hidden'>
//       <motion.div
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
//         exit={{ opacity: 0 }}
//         className="flex flex-col items-center justify-center px-4 py-12 max-w-3xl mx-auto text-center"
//       >
//         <h2 className="text-2xl font-['Gilroy-Medium'] text-white mb-8">
//           Analyzing Your Responses
//         </h2>
...
//             whileTap={{ scale: 0.98 }}
//             onClick={handleManualContinue}
//             className="px-6 py-0 bg-navy text-white rounded-3xl shadow-md hover:bg-navy/90 transition-colors mt-1 font-['Gilroy-SemiBold'] h-12 text-xl"
//           >
//             Continue to Results
//           </motion.button>
//         )}
...
//           animate={{ opacity: 1 }}
//           transition={{ delay: 1 }}
//           className="text-sm text-gray-500 mt-1 max-w-md font-['Gilroy-SemiBold']"
//         >
//           Our AI is analyzing your responses to provide personalized insights.
