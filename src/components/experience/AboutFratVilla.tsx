    ...
    <section className="py-4 md:py-8 bg-gradient-to-br from-cyan-800 to-blue-900 ">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
            <h2 
                className="section-header mb-6 bg-gradient-to-b from-cyan-400 to-neutral-300 bg-clip-text text-transparent"
            >
                About FratVilla
            </h2>
            
            <p 
                className="section-p mb-8 text-transparent bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-400"
            >
            ...
            <section className=" lg:py-8 md:py-0 md:px-0 lg:px-4 lg:backdrop-blur-md lg:bg-gradient-to-br lg:from-cyan-700 lg:to-blue-900 rounded-xl lg:shadow-2xl lg:hover:shadow-lg">
                <div className="container mx-auto px-0">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 
                className="section-header mb-2 bg-gradient-to-b from-cyan-400 to-neutral-300 bg-clip-text text-transparent"
            >
                What FratVilla Does
            </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        ...
                        >
                            <h3 
                            className="text-xl md:text-2xl lg:text-3xl font-['Gilroy-Bold'] text-neutral-300 sm:h-16 md:h-28 lg:h-24 lg:mb-4"
                            >
                            {feature.title}
                            </h3>
                            <p 
                            className="text-lg font-['Gilroy-Regular'] md:text-xl lg:text-xl text-transparent bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-400"
                            >
                            {feature.description}
                            </p>
                        </div>
