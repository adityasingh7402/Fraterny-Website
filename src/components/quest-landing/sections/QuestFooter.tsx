  ...
  return (
    <div>
        <div className='flex-col items-start justify-start pl-6 pt-4 mb-4'>
            <div>
            <img src={img} alt="Quest Footer" className='h-24 w-24' />
            </div>
            ...
            <div className='flex space-x-8 pb-4'>
                <a href="mailto:quest@fratery.in?subject=Refund Request" aria-label="Facebook">
                    <Mail className='h-6 w-6 text-blue-600' />
                </a>
                <a href="https://www.instagram.com/quest.fraterny/" aria-label="Instagram">
                    <Instagram className='h-6 w-6 text-pink-600' />
                </a>
                <a href="https://x.com/frat_erny" aria-label="Youtube">
